...
class Flight(models.Model):
    ...
    from_country = models.ForeignKey('countries.Country', on_delete=models.CASCADE, related_name="flight_from_country_set", verbose_name="From country", null=True)
    to_country = models.ForeignKey('countries.Country', on_delete=models.CASCADE, related_name="flight_to_country_set", verbose_name="To country", null=True)
    ...
    user_id = models.ForeignKey('accounts.User', on_delete=models.CASCADE, related_name="user_flight_set", verbose_name="User", null=True)
    ...
    def clean(self):
        ...
        qs = Flight.objects.filter(from_country=self.from_country,
